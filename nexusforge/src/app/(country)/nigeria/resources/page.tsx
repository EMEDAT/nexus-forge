import { nigerianResources } from '@/config/countries/nigeria/resources';

export default function NigeriaResources() {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-4xl font-bold mb-8 text-green-800">Nigerian Architectural Resources</h1>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {nigerianResources.map((resource) => (
          <div key={resource.id} className="bg-white shadow-lg rounded-lg p-6 border border-gray-100">
            ...
            <h2 className="text-2xl font-semibold mb-4 text-green-700">{resource.title}</h2>
