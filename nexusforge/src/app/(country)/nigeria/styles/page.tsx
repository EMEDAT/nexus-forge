...
import { nigerianArchitecturalStyles } from '@/config/countries/nigeria/styles';

export default function NigerianArchitecturalStyles() {
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-4xl font-bold mb-8 text-green-800">Architectural Styles of Nigeria</h1>
      
      {nigerianArchitecturalStyles.map((style) => (
        <div key={style.id} className="mb-12 bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            <h2 className="text-3xl font-bold mb-4 text-green-700">{style.name}</h2>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {style.examples.map((example, index) => (
                    <div key={index} className="bg-green-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-green-800">{example.name}</h4>
