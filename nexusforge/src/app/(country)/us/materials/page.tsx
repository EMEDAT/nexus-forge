import { usMaterials } from '@/config/countries/us/materials';

export default function USMaterials() {
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-4xl font-bold mb-8 text-blue-800">US Construction Materials</h1>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {usMaterials.map((material) => (
          <div key={material.id} className="bg-white shadow-lg rounded-lg p-6 border border-gray-100">
            <h2 className="text-2xl font-semibold mb-4 text-blue-700">{material.name}</h2>
